...
datasets~\cite{zeiler2010deconvolutional}, that each consist of 10
...
Fig.~\ref{fig:subsampleResult} \changed{(the comparison method uses a similar number of iterations as ours to reach convergence)}. A different selection of the
