...
only takes about $50\%$ of the time for our method. Specifically, SBCSC takes 170 seconds and the comparable method takes 350 seconds for 14 iterations on a Core i7 PC. \todo{specific
  times here!}.
\note{So, how does Bis' work from last year compare in terms of
  quality and time? It should
  have much better dictionaries than~\cite{heide2015fast} as well.}
