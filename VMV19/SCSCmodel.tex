...
\changed{Our proposed randomization approach shares a similar idea as utilized in the stochastic Frank-Wolfe
algorithm~\cite{reddi2016stochastic,pmlr-v80-kerdreux18a}.  The general idea of that is to solve the optimization problem on a subset of the variables at each iteration, which are
